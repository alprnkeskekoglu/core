    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('dawnstar.roles.store') }}" id="roleStore" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-lg-12">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="mb-3 col-lg-9">
                                                            <div class="form-check form-check-inline form-radio-success">
                                                                <input type="radio" id="admin_{{ $type }}_1" name="permissions[admin.{{ $type }}]" class="form-check-input" value="1" {{ old('permissions.admin.' . $type, 1) == 1 ? 'checked' : '' }}>
                                                                <label class="form-check-label" for="admin_{{ $type }}_1">@lang('Dawnstar::general.status_options.1')</label>
                                                            </div>
                                                            <div class="form-check form-check-inline form-radio-danger">
                                                                <input type="radio" id="admin_{{ $type }}_0" name="permissions[admin.{{ $type }}]" class="form-check-input" value="0" {{ old('permissions.admin.' . $type, 1) == 0 ? 'checked' : '' }}>
                                            ...
                                            <div class="card-body">
                                                @foreach($types as $type)
                                                    <div class="row">
                                                        ...
                                                        <div class="mb-3 col-lg-9">
                                                            <div class="form-check form-check-inline form-radio-success">
                                                                <input type="radio" id="role_{{ $type }}_1" name="permissions[role.{{ $type }}]" class="form-check-input" value="1" {{ old('permissions.role.' . $type, 1) == 1 ? 'checked' : '' }}>
                                                                <label class="form-check-label" for="role_{{ $type }}_1">@lang('Dawnstar::general.status_options.1')</label>
                                                            </div>
                                                            <div class="form-check form-check-inline form-radio-danger">
                                                                <input type="radio" id="role_{{ $type }}_0" name="permissions[role.{{ $type }}]" class="form-check-input" value="0" {{ old('permissions.role.' . $type, 1) == 0 ? 'checked' : '' }}>
                                            ...
                                            <div class="card-body">
                                                @foreach($types as $type)
                                                    <div class="row">
                                                        ...
                                                        <div class="mb-3 col-lg-9">
                                                            <div class="form-check form-check-inline form-radio-success">
                                                                <input type="radio" id="form_{{ $type }}_1" name="permissions[form.{{ $type }}]" class="form-check-input" value="1" {{ old('permissions.form.' . $type, 1) == 1 ? 'checked' : '' }}>
                                                                <label class="form-check-label" for="form_{{ $type }}_1">@lang('Dawnstar::general.status_options.1')</label>
                                                            </div>
                                                            <div class="form-check form-check-inline form-radio-danger">
                                                                <input type="radio" id="form_{{ $type }}_0" name="permissions[form.{{ $type }}]" class="form-check-input" value="0" {{ old('permissions.form.' . $type, 1) == 0 ? 'checked' : '' }}>
                                            ...
                                            <div class="card-body">
                                                @foreach($types as $type)
                                                    <div class="row">
                                                        ...
                                                        <div class="mb-3 col-lg-9">
                                                            <div class="form-check form-check-inline form-radio-success">
                                                                <input type="radio" id="custom_translation_{{ $type }}_1" name="permissions[custom_translation.{{ $type }}]" class="form-check-input" value="1" {{ old('permissions.custom_translation.' . $type, 1) == 1 ? 'checked' : '' }}>
                                                                <label class="form-check-label" for="custom_translation_{{ $type }}_1">@lang('Dawnstar::general.status_options.1')</label>
                                                            </div>
                                                            <div class="form-check form-check-inline form-radio-danger">
                                                                <input type="radio" id="custom_translation_{{ $type }}_0" name="permissions[custom_translation.{{ $type }}]" class="form-check-input" value="0" {{ old('permissions.custom_translation.' . $type, 1) == 0 ? 'checked' : '' }}>
                                                            ...
                                                            <div class="mb-3 col-lg-9">
                                                                <div class="form-check form-check-inline form-radio-success">
                                                                    <input type="radio" id="website_{{ $website->id }}_{{ $type }}_1"
                                                                        ...
                                                                        {{ old('permissions.website.' . $website->id . '.' . $type, 1) == 1 ? 'checked' : '' }}>
                                                                ...
                                                                <div class="form-check form-check-inline form-radio-danger">
                                                                    <input type="radio" id="website_{{ $website->id }}_{{ $type }}_0"
                                                                        ...
                                                                        {{ old('permissions.website.' . $website->id . '.' . $type, 1) == 0 ? 'checked' : '' }}>
                                                                        ...
                                                                        <div class="card-body">
                                                                            @foreach($types as $type)
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="mb-3 col-lg-9">
                                                                                        <div class="form-check form-check-inline form-radio-success">
                                                                                            <input type="radio" id="website_{{ $website->id }}_menu_{{ $type }}_1" name="permissions[{{ "website.{$website->id}.menu.{$type}" }}]" class="form-check-input" value="1" {{ old("permissions.website.{$website->id}.menu.{$type}", 1) == 1 ? 'checked' : '' }}>
                                                                                            <label class="form-check-label" for="website_{{ $website->id }}_menu_{{ $type }}_1">@lang('Dawnstar::general.status_options.1')</label>
                                                                                        </div>
                                                                                        <div class="form-check form-check-inline form-radio-danger">
                                                                                            <input type="radio" id="website_{{ $website->id }}_menu_{{ $type }}_0" name="permissions[{{ "website.{$website->id}.menu.{$type}" }}]" class="form-check-input" value="0" {{ old("permissions.website.{$website->id}.menu.{$type}", 1) == 0 ? '' : 'checked' }}>
                                                                        ...
                                                                        <div class="card-body">
                                                                            @foreach($types as $type)
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="mb-3 col-lg-9">
                                                                                        <div class="form-check form-check-inline form-radio-success">
                                                                                            <input type="radio" id="website_{{ $website->id }}_structure_{{ $type }}_1" name="permissions[{{ "website.{$website->id}.structure.{$type}" }}]" class="form-check-input" value="1" {{ old("permissions.website.{$website->id}.structure.{$type}", 1) == 1 ? 'checked' : '' }}>
                                                                                            <label class="form-check-label" for="website_{{ $website->id }}_structure_{{ $type }}_1">@lang('Dawnstar::general.status_options.1')</label>
                                                                                        </div>
                                                                                        <div class="form-check form-check-inline form-radio-danger">
                                                                                            <input type="radio" id="website_{{ $website->id }}_structure_{{ $type }}_0" name="permissions[{{ "website.{$website->id}.structure.{$type}" }}]" class="form-check-input" value="0" {{ old("permissions.website.{$website->id}.structure.{$type}", 1) == 0 ? '' : 'checked' }}>
                                                                ...
                                                                @foreach($website->structures as $structure)
                                                                    <div class="card mb-0">
                                                                        ...
                                                                        <div id="{{ $structure->key }}Collapse" class="collapse" aria-labelledby="{{ $structure->key }}Header" data-bs-parent="#accordion{{ $website->id }}">
                                                                            <div class="card-body">
                                                                                @foreach($types as $type)
                                                                                    @continue($structure->type != 'dynamic' && in_array($type, ['index', 'create', 'store']))
                                                                                    <div class="row">
                                                                                        <label class="form-label col-lg-3">@lang('Dawnstar::role.types.' . $type)</label>
                                                                                        <div class="mb-3 col-lg-9">
                                                                                            <div class="form-check form-check-inline form-radio-success">
                                                                                                <input type="radio" id="{{ $structure->key . '_' . $type }}_1" name="permissions[{{ "website.{$website->id}.structure.{$structure->id}.{$type}" }}]" class="form-check-input"
                                                                                                       value="1" {{ old("permissions.website.{$website->id}.structure.{$structure->id}.{$type}", 1) == 1 ? 'checked' : '' }}>
                                                                                            ...
                                                                                            <div class="form-check form-check-inline form-radio-danger">
                                                                                                <input type="radio" id="{{ $structure->key . '_' . $type }}_0" name="permissions[{{ "website.{$website->id}.structure.{$structure->id}.{$type}" }}]" class="form-check-input"
                                                                                                       value="0" {{ old("permissions.website.{$website->id}.structure.{$structure->id}.{$type}", 1) == 0 ? 'checked' : '' }}>
                ...
                <div class="card-footer text-end">
                    <button type="submit" class="btn btn-primary" form="roleStore">@lang('Dawnstar::general.save')</button>
                </div>
            </div>
        </div>
    </div>
