...
@section('content')
    @include('Core::includes.page_header',['headerTitle' => __('Core::structure.title.edit')])
    <div class="row">
        <div class="col-12">
            <div class="card">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-floating mb-3">
                                    ...
                                    <label for="name">@lang('Core::structure.labels.type')</label>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-floating mb-3">
                ...
                <div class="card-footer text-end">
                    <button type="submit" class="btn btn-primary" form="structureUpdate">@lang('Core::general.save')</button>
                </div>
            </div>
        </div>
    </div>
