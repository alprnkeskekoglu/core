                                    ...
                                    <form action="{{ route('dawnstar.menus.items.update', [$menu, $item]) }}" method="POST">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 mb-4">
                                                @include('MediaManager::includes.media_box',['label' => __('Core::menu_item.labels.image'), 'medias' => $item->mc_image, 'key' => 'image', 'max_count' => '1'])
                                            </div>
                                            <div class="col-lg-12">
                                            ...
                                            <div class="col-lg-12 d-none" id="targetBox">
                                                <div class="form-floating mb-3">
                                                    <select class="form-select @error('target') is-invalid @enderror" id="target" name="target">
                                                        <option value="">@lang('Core::general.select')</option>
                                                        <option value="_self" {{ old('target', $item->target) == '_self' ? 'selected' : '' }}>@lang('Core::menu_item.targets.self')</option>
                                                        <option value="_blank" {{ old('target', $item->target) == '_blank' ? 'selected' : '' }}>@lang('Core::menu_item.targets.blank')</option>
                                                    </select>
