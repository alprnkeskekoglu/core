                            ...
                            <div class="row">
                                <div class="col-lg-7">
                                    <button type="button" class="btn btn-dark mb-2" id="orderSaveBtn">
                                        ...
                                        @lang('Dawnstar::menu_item.order_save')
                                    </button>
                                    ...
                                    <form action="{{ route('dawnstar.menus.items.store', $menu) }}" method="POST">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 mb-4">
                                                @include('MediaManager::includes.media_box',['label' => __('Dawnstar::menu_item.labels.image'), 'key' => 'image', 'max_count' => '1'])
                                            </div>
                                            <div class="col-lg-12">
                                            ...
                                            <div class="col-lg-12 d-none" id="targetBox">
                                                <div class="form-floating mb-3">
                                                    <select class="form-select @error('target') is-invalid @enderror" id="target" name="target">
                                                        <option value="">@lang('Dawnstar::general.select')</option>
                                                        <option value="_self" {{ old('target') == '_self' ? 'selected' : '' }}>@lang('Dawnstar::menu_item.targets.self')</option>
                                                        <option value="_blank" {{ old('target') == '_blank' ? 'selected' : '' }}>@lang('Dawnstar::menu_item.targets.blank')</option>
                                                    </select>
            ...
            $('#orderSaveBtn').on('click', function () {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        showMessage('success', '', '@lang('Dawnstar::menu_item.success.order')')
                    },
