...
@section('content')
    @include('Core::includes.page_header',['headerTitle' => __('Core::menu.title.create')])
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('dawnstar.menus.store') }}" id="menuStore" method="POST">
                        ...
                        <button type="submit" class="btn btn-primary" form="menuStore">@lang('Core::general.save')</button>
                    </form>
                </div>
            </div>
        </div>
