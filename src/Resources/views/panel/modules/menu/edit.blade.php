...
@section('content')
    @include('Dawnstar::includes.page_header',['headerTitle' => __('Dawnstar::menu.title.edit')])
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('dawnstar.menus.update', $menu) }}" id="menuUpdate" method="POST">
                        ...
                        <button type="submit" class="btn btn-primary" form="menuUpdate">@lang('Dawnstar::general.save')</button>
                    </form>
                </div>
            </div>
        </div>
