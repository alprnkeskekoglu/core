                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="btn-group">
                                        ...
                                        <a href="{{ route('dawnstar.menu.content.index', ['menuId' => $menu->id]) }}" class="btn btn-sm btn-secondary" data-toggle="tooltip" data-placement="bottom" title="{{ __('DawnstarLang::menu.content_title') }}">
