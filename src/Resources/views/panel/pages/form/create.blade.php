    ...
    <main id="main-container">
        ...
        <div class="content content-max-width">
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                <h1 class="flex-sm-fill font-size-h2 font-w400 mt-2 mb-0 mb-sm-2">{{ __('DawnstarLang::form.create_title') }}</h1>
        ...
        <div class="content">
            ...
            <form action="{{ route('dawnstar.form.store') }}" method="POST">
                @csrf
                <div class="block block-rounded">
                    <div class="block-header block-header-default block-header-rtl">
                        <div class="block-options">
                            <a href="{{ route('dawnstar.form.index') }}" class="btn btn-sm btn-outline-secondary">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control form-control-alt" id="key" disabled="disabled">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="sender" name="sender" value="{{ old('sender') }}">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="receivers">{{ __('DawnstarLang::form.labels.receivers') }}</label>
                                            <input type="text" class="form-control" id="receivers" name="receivers" value="{{ old('receivers') }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mt-4">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="custom-control custom-radio custom-control-inline custom-control-success custom-control-lg">
                                                <input type="radio" class="custom-control-input" id="recapthca_status_active" name="recaptcha_status" value="1" {{ old('recaptcha_status') == 1 ? 'checked' : '' }}>
                                                <label class="custom-control-label" for="recapthca_status_active">{{ __('DawnstarLang::general.status_title.active') }}</label>
                                            </div>
                                            <div class="custom-control custom-radio custom-control-inline custom-control-danger custom-control-lg">
                                                <input type="radio" class="custom-control-input" id="recapthca_status_passive" name="recaptcha_status" value="3" {{ old('recaptcha_status', 3) == 3 ? 'checked' : '' }}>
                                                <label class="custom-control-label" for="recapthca_status_passive">{{ __('DawnstarLang::general.status_title.passive') }}</label>
                                            </div>
                                        </div>
                                    </div>

                                    <div class="col-md-6 d-none recaptchaDiv">
                                        <div class="form-group">
                                            <label for="recaptcha_site_key">{{ __('DawnstarLang::form.labels.recaptcha_site_key') }}</label>
                                            <input type="text" class="form-control" id="recaptcha_site_key" name="recaptcha_site_key" value="{{ old('recaptcha_site_key') }}">
                                        </div>
                                    </div>
                                    <div class="col-md-6 d-none recaptchaDiv">
                                        <div class="form-group">
                                            <label for="recaptcha_secret_key">{{ __('DawnstarLang::form.labels.recaptcha_secret_key') }}</label>
                                            <input type="text" class="form-control" id="recaptcha_secret_key" name="recaptcha_secret_key" value="{{ old('recaptcha_secret_key') }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
