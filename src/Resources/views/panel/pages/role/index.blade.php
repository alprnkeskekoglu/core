    ...
    <main id="main-container">
        ...
        <div class="content content-max-width">
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                <h1 class="flex-sm-fill font-size-h2 font-w400 mt-2 mb-0 mb-sm-2">{{ __('DawnstarLang::role.index_title') }}</h1>
            ...
            <div class="block block-rounded">
                <div class="block-content">
                    ...
                    <div class="row items-push justify-content-end text-right">
                        <div class="mr-2">
                            <a href="{{ route('dawnstar.roles.create') }}" class="btn btn-sm btn-primary" data-toggle="click-ripple">
                    ...
                    <table class="table table-striped table-vcenter">
                        ...
                        <tr>
                            ...
                            <th>{{ __('DawnstarLang::role.labels.name') }}</th>
