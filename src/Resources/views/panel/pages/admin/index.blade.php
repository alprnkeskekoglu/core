    ...
    <main id="main-container">
        ...
        <div class="content content-max-width">
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                <h1 class="flex-sm-fill font-size-h2 font-w400 mt-2 mb-0 mb-sm-2">{{ __('DawnstarLang::admin.index_title') }}</h1>
                ...
                <div class="block-content">
                    ...
                    <table class="table table-striped table-vcenter">
                        ...
                        <tr>
                            ...
                            <th class="text-center">{{ __('DawnstarLang::admin.labels.status') }}</th>
                            <th>{{ __('DawnstarLang::admin.labels.role_id') }}</th>
                            <th>{{ __('DawnstarLang::admin.labels.fullname') }}</th>
                            <th>{{ __('DawnstarLang::admin.labels.email') }}</th>
                        ...
                        @foreach($admins as $admin)
                            <tr>
                                ...
                                <td class="text-center">
                                    <span class="badge badge-{{ getStatusColorClass($admin->status) }} fa-1x p-2">
