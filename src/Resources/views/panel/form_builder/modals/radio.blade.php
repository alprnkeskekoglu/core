                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="option_label_en" name="options[{{$key}}][text][en]" placeholder="en..." value="{{ $option['text']['en'] ?? '' }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="col-sm-9">
                                            <select class="form-control" id="example-select" name="options[{{$key}}][color]">
                                                ...
                                                @foreach($colors as $color)
                                                    <option value="{{ $color }}" {{ isset($option['color']) && $option['color'] == $color ? 'selected' : '' }}>{{ ucwords($color) }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
