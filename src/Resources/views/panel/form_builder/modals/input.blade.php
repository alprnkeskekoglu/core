    ...
    <div class="modal-content">
        ...
        <div class="modal-body pb-1">
            <form action="{{ route('dawnstar.form_builders.saveElement') }}" id="elementForm" method="POST">
                ...
                <div class="form-group row">
                    <label class="col-sm-2 col-form-label" for="attr_type">Type</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="attr_type" name="input[attributes][type]" value="{{ $element['input']['attributes']['type'] ?? 'text' }}">
                    </div>
                </div>
                <div class="form-group row">
